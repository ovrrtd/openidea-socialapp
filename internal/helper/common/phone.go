...
func ValidatePhoneNumber(phoneNumber string) bool {
	...
	callingCodes := []string{
		"1",   // United States, Canada, and several Caribbean nations
		"44",  // United Kingdom
		"61",  // Australia
		"49",  // Germany
		"33",  // France
		...
		"45",  // Denmark
		"64",  // New Zealand
		"61",  // Antarctica (Australian territory)
		"20",  // Egypt
		"27",  // South Africa
		"30",  // Greece
		"31",  // Netherlands
		...
		"509", // Haiti
		"590", // Guadeloupe and Saint Martin
		"591", // Bolivia
		"592", // Guyana
		"593", // Ecuador
		"594", // French Guiana
		...
		"597", // Suriname
		"598", // Uruguay
		"599", // Curaçao, Bonaire, Saba and Sint Eustatius
		...
		"886", // Taiwan
		"888", // Global Mobile Satellite System (GMSS), international networks
		"960", // Maldives
		"961", // Lebanon
		"962", // Jordan
		"963", // Syria
